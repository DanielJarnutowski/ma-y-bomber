...
class LevelSelectSubState extends FlxSubState {
  ...
  function createWhichLevel() {
    ...
    titleText = new FlxText(10, 24, -1, "Choose Your Level", Globals.FONT_L);
  ...
  public function createDarkLevelImage() {
    ...
    darkLevelImage.loadGraphic(AssetPaths.darklevel__png, false, 100, 100);
  ...
  public function createStarterLevelImage() {
    ...
    starterLevelImage.loadGraphic(AssetPaths.starterlevel__png, false, 100,
      100);
  ...
  public function createFireLevelImage() {
    ...
    fireLevelImage.loadGraphic(AssetPaths.firelevel__png, false, 100, 100);
  ...
  public function createIceLevelImage(x:Float, y:Float) {
    ...
    iceLevelImage.loadGraphic(AssetPaths.icelevel__png, false, 100, 100);
  ...
  function levelButtons(x:Float, y:Float) {
    ...
    add(choiceOneButton);
    choiceTwoButton = new FlxButton(687 + xOffset, y + yOffset, 'Light',
      choice);
    choiceTwoButton.x -= (choiceTwoButton.width * 3 + 12);
    add(choiceTwoButton);
    choiceThreeButton = new FlxButton(168 + xOffset, 255 + yOffset, 'Fire',
      choice);
    add(choiceThreeButton);
    choiceFourButton = new FlxButton(435 + xOffset, 255 + yOffset, 'Ice',
      choice);
